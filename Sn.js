...
const Cities = (props) => {
	return(
		...
		<View style={styles.input}>
			...
			<TextInput style={{fontSize:15,paddingLeft:5}} placeholder="Write a city name" value={props.textValue} onChangeText = {props.handleTextChange}   underlineColorAndroid='transparent'/>
		</View>	
